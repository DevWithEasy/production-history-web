...
export default function OpeningValueUpdate() {
  ...
  const downloadTemplate = () => {
    ...
    XLSX.writeFile(
      workbook,
      `opening_template_${new Date().toISOString().split("T")[0]}.xlsx`,
    );
  };
  ...
  const downloadCurrentData = () => {
    ...
    const wscols = [{ wch: 15 }, { wch: 30 }, { wch: 12 }, { wch: 12 }];
    worksheet["!cols"] = wscols;

    XLSX.writeFile(
      workbook,
      `current_products_${new Date().toISOString().split("T")[0]}.xlsx`,
    );
  };
              ...
              <div className="flex items-center gap-3">
                ...
                <div>
                  ...
                  <p className="text-blue-700 font-(family-name:--font-tiro-bangla)">
                    {monthName} {year} • কালেকশন: production/{year}/months/
                    {monthName}/products
                  </p>
                </div>
              </div>
                      ...
                      return (
                        ...
                        >
                          ...
                          <td className="p-3 font-mono">
                            <code
                              className={`px-2 py-1 rounded ${isMatched ? "bg-green-100 text-green-800" : "bg-red-100 text-red-800"}`}
                            >
                              {item.code}
                            </code>
                          </td>
                    ...
                    {filteredProducts.slice(0, 10).map((product, i) => {
                      ...
                      return (
                        ...
                        >
                          <td className="p-3">
                            <code
                              className={`px-2 py-1 rounded font-mono ${hasExcelMatch ? "bg-green-100 text-green-800" : "bg-gray-100 text-gray-800"}`}
                            >
                              {product.code}
                            </code>
                          </td>
        ...
        <div className="mt-8 grid grid-cols-1 md:grid-cols-3 gap-6">
          <div className="bg-gradient-to-r from-blue-50 to-white p-5 rounded-xl border border-blue-200">
            ...
            <p className="text-gray-600 text-sm font-(family-name:--font-tiro-bangla)">
              ফাইলে code, name, opening, price কলাম থাকতে হবে। কোড দ্বারা
              ম্যাচিং হয়।
            </p>
          </div>
          ...
          <div className="bg-linear-to-r from-green-50 to-white p-5 rounded-xl border border-green-200">
            ...
            <p className="text-gray-600 text-sm font-(family-name:--font-tiro-bangla)">
              আপডেট করার আগে প্রিভিউ দেখুন। একবার আপডেট করলে পূর্বের ডাটা
              পরিবর্তন হবে।
            </p>
          </div>
