...
export default function ManpowerUpdate() {
  ...
  const loadData = async () => {
    setLoading(true);
    try {
      const data = (await Firebase.getManpowerByPeriod(
        year,
        monthName
      )) as ManpowerResponse | null;
                  ...
                  <tbody>
                      ...
                      return (
                        ...
                        >
                          ...
                          {daysArray.map((day) => {
                            ...
                            const currentValue =
                              manpowerData[dateStr]?.[section.id] || 0;
                    ...
                    <tr className="border-t-2 border-blue-300 bg-blue-50">
                      ...
                      {daysArray.map((day) => {
                        ...
                        const currentValue =
                          manpowerData[dateStr]?.total_manpower || 0;
                          ...
                          >
                            <div className="relative">
                              <input
                                ...
                                defaultValue={currentValue}
                                onChange={(e) =>
                                  handleTotalChange(dateStr, e.target.value)
                                }
