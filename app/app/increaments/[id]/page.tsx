...
import { Edit2, Printer, Save, X, Plus, Trash2, UserPlus, FileText, Calendar, FileSignature, Download, ArrowLeft, Users } from "lucide-react";
...
export default function Increment() {
  ...
  const [originalIncreament, setOriginalIncreament] = useState<Increament | null>(null);
  ...
  const handlePrint = useReactToPrint({
    contentRef,
    documentTitle: `বেতন_বৃদ্ধি_আবেদন_${increament?.name || "Document"}_${new Date().toISOString().split("T")[0]}`,
    pageStyle: `
    ...
    onBeforeGetContent: () => {
      ...
      link.href = "https://fonts.googleapis.com/css2?family=Tiro+Bangla:wght@400;700&display=swap";
      link.rel = "stylesheet";
  ...
  useEffect(() => {
    if (increament && originalIncreament) {
      const isChanged = JSON.stringify(increament) !== JSON.stringify(originalIncreament);
  ...
  const updatePersonField = (index: number, field: keyof Person, value: string) => {
    if (!increament) return;
    const updatedPersons = [...(increament.person || [])];
  ...
  const deleteDocument = async () => {
    if (!confirm("আপনি কি এই আবেদনটি মুছতে চান? এই কাজটি পূর্বাবস্থায় ফেরানো যাবে না।")) return;
    try {
      ...
      <div className="min-h-screen flex items-center justify-center bg-gray-50">
        <div className="text-center">
          ...
          <p className="text-gray-600">
            অনুরোধকৃত আবেদনটি সিস্টেমে নেই।
          </p>
        </div>
      </div>
    );
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-gray-50 p-4 md:p-6">
              ...
              <div>
                <h1 className="text-2xl font-bold text-gray-800 mb-1 flex items-center gap-2">
                  ...
                  {editMode ? (
                    ...
                    <span className="font-[family-name:var(--font-tiro-bangla)]">{increament.name}</span>
                  )}
                </h1>
                <div className="flex flex-wrap items-center gap-4 text-sm text-gray-600">
                  ...
                  {saving && (
                    <span className="text-blue-600 font-medium">সংরক্ষণ হচ্ছে...</span>
                  )}
                  {hasChanges && (
                    <span className="text-amber-600 font-medium">• অসংরক্ষিত পরিবর্তন</span>
                  )}
                </div>
              </div>
            </div>
              ...
              {editMode ? (
                ...
                <>
                  <button
                    ...
                    className="px-5 py-2.5 bg-gradient-to-r from-blue-600 to-blue-700 text-white rounded-lg font-medium hover:from-blue-700 hover:to-blue-800 transition-all duration-200 flex items-center gap-2"
                  >
                  ...
                  <button
                    onClick={handlePrint}
                    className="px-5 py-2.5 bg-gradient-to-r from-green-600 to-green-700 text-white rounded-lg font-medium hover:from-green-700 hover:to-green-800 transition-all duration-200 flex items-center gap-2"
                  >
                  ...
                  <button
                    ...
                    className="px-5 py-2.5 bg-gradient-to-r from-purple-600 to-purple-700 text-white rounded-lg font-medium hover:from-purple-700 hover:to-purple-800 transition-all duration-200 flex items-center gap-2"
                  >
                  ...
                  <button
                    ...
                    className="px-5 py-2.5 bg-gradient-to-r from-red-100 to-red-200 text-red-700 rounded-lg font-medium hover:from-red-200 hover:to-red-300 transition-all duration-200 flex items-center gap-2"
                  >
        ...
        <div className="bg-white rounded-xl shadow-lg p-6">
          {editMode ? (
            ...
            <div className="space-y-8">
              ...
              <div className="bg-gradient-to-r from-blue-50 to-white p-6 rounded-xl border border-blue-200">
                <div className="flex items-center justify-between mb-6">
                  ...
                  <button
                    ...
                    className="text-sm text-blue-600 hover:text-blue-800 font-[family-name:var(--font-tiro-bangla)]"
                  >
                ...
                <textarea
                  ...
                  rows={8}
                  className="w-full px-4 py-3 border-2 border-gray-300 rounded-xl focus:ring-2 focus:ring-blue-500 focus:border-blue-500 outline-none transition-all font-[family-name:var(--font-tiro-bangla)] resize-y text-base"
              ...
              <div className="bg-gradient-to-r from-green-50 to-white p-6 rounded-xl border border-green-200">
                <div className="flex items-center gap-3 mb-6">
                  ...
                  <h2 className="text-xl font-semibold text-gray-800">নতুন কর্মী যোগ করুন</h2>
                </div>
                
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4 mb-6">
                  <div>
                    <label className="block text-sm font-medium text-gray-700 mb-2 font-[family-name:var(--font-tiro-bangla)]">
                      কর্মীর নাম
                    </label>
                    <input
                      type="text"
                  ...
                  <div>
                    ...
                    <input
                      ...
                      onChange={(e) => setNewPerson({ ...newPerson, p_id: e.target.value })}
                  ...
                  <div>
                    ...
                    <input
                      ...
                      onChange={(e) => setNewPerson({ ...newPerson, join_date: e.target.value })}
                      className="w-full px-4 py-2.5 border-2 border-gray-300 rounded-lg focus:ring-2 focus:ring-green-500 focus:border-green-500 outline-none"
                    />
                  </div>
                  ...
                  <div>
                    ...
                    <input
                      ...
                      onChange={(e) => setNewPerson({ ...newPerson, pre_salary: e.target.value })}
                      placeholder="টাকায়"
                      className="w-full px-4 py-2.5 border-2 border-gray-300 rounded-lg focus:ring-2 focus:ring-green-500 focus:border-green-500 outline-none"
                    />
                  </div>
                  ...
                  <div>
                    ...
                    <input
                      ...
                      onChange={(e) => setNewPerson({ ...newPerson, pro_salary: e.target.value })}
                      placeholder="টাকায়"
                      className="w-full px-4 py-2.5 border-2 border-gray-300 rounded-lg focus:ring-2 focus:ring-green-500 focus:border-green-500 outline-none"
                    />
                  </div>
                  ...
                  <div className="overflow-x-auto">
                    <table className="min-w-full divide-y divide-gray-200 border border-gray-200">
                      <thead className="bg-gray-100">
                        <tr>
                          <th className="px-4 py-3 text-left text-xs font-medium text-gray-700 uppercase tracking-wider font-[family-name:var(--font-tiro-bangla)]">
                            ক্রমিক
                          </th>
                          <th className="px-4 py-3 text-left text-xs font-medium text-gray-700 uppercase tracking-wider font-[family-name:var(--font-tiro-bangla)]">
                            নাম
                        ...
                        {increament.person.map((p, i) => (
                          <tr key={i} className="hover:bg-gray-50 transition-colors">
                            ...
                            <td className="px-4 py-3 text-sm">
                              <select
                                value={p.section}
                                onChange={(e) => updatePersonField(i, "section", e.target.value)}
                                className="px-2 py-1.5 border border-gray-300 rounded w-full focus:ring-1 focus:ring-blue-500 focus:border-blue-500 outline-none"
                              >
                                {["বিস্কুট", "ওয়েফার", "কেক"].map((s) => (
                                  <option key={s} value={s}>
                            ...
                            <td className="px-4 py-3 text-sm">
                              <input
                                type="text"
                                value={p.p_id}
                                onChange={(e) => updatePersonField(i, "p_id", e.target.value)}
                                className="px-2 py-1.5 border border-gray-300 rounded w-full focus:ring-1 focus:ring-blue-500 focus:border-blue-500 outline-none"
                              />
                            </td>
                            <td className="px-4 py-3 text-sm">
                              <input
                                type="date"
                                value={p.join_date}
                                onChange={(e) => updatePersonField(i, "join_date", e.target.value)}
                                className="px-2 py-1.5 border border-gray-300 rounded w-full focus:ring-1 focus:ring-blue-500 focus:border-blue-500 outline-none"
                              />
                            </td>
                            <td className="px-4 py-3 text-sm">
                              <input
                                type="number"
                                value={p.pre_salary}
                                onChange={(e) => updatePersonField(i, "pre_salary", e.target.value)}
                                className="px-2 py-1.5 border border-gray-300 rounded w-full focus:ring-1 focus:ring-blue-500 focus:border-blue-500 outline-none"
                              />
                            </td>
                            <td className="px-4 py-3 text-sm">
                              <input
                                type="number"
                                value={p.pro_salary}
                                onChange={(e) => updatePersonField(i, "pro_salary", e.target.value)}
                                className="px-2 py-1.5 border border-gray-300 rounded w-full focus:ring-1 focus:ring-blue-500 focus:border-blue-500 outline-none"
                              />
                            </td>
                            <td className="px-4 py-3 text-sm">
              ...
              <div className="bg-gradient-to-r from-purple-50 to-white p-6 rounded-xl border border-purple-200">
                <div className="flex items-center justify-between mb-6">
                  ...
                  <button
                    ...
                    className="text-sm text-purple-600 hover:text-purple-800 font-[family-name:var(--font-tiro-bangla)]"
                  >
                    টেমপ্লেট ব্যবহার করুন
                  </button>
                </div>
                <textarea
                  ...
                  rows={6}
                  className="w-full px-4 py-3 border-2 border-gray-300 rounded-xl focus:ring-2 focus:ring-purple-500 focus:border-purple-500 outline-none transition-all font-[family-name:var(--font-tiro-bangla)] resize-y text-base"
            ...
            <div ref={contentRef} className="print-container">
              ...
              <link
                href="https://fonts.googleapis.com/css2?family=Tiro+Bangla:wght@400;700&display=swap"
                rel="stylesheet"
              />
              ...
              <div className="hidden print:block mb-8">
                <div className="text-center">
                  <h1 className="text-2xl font-bold mb-2 font-[family-name:var(--font-tiro-bangla)]">
                    বেতন বৃদ্ধির জন্য আবেদন
                  </h1>
                  <div className="flex justify-between items-start mt-6">
                    <div className="text-left">
                      <p className="text-sm font-[family-name:var(--font-tiro-bangla)]">
              ...
              {/* Header Content */}
              <div className="mb-8">
                <div className="whitespace-pre-line text-gray-800 font-[family-name:var(--font-tiro-bangla)] text-base leading-relaxed">
                  {increament.header}
                </div>
              </div>
              ...
              {increament.person && increament.person.length > 0 ? (
                <div className="mb-8 overflow-x-auto">
                  <table className="min-w-full divide-y divide-gray-200 border border-gray-300 font-[family-name:var(--font-tiro-bangla)]">
                    <thead className="bg-gray-100">
                      <tr>
                    ...
                    <tbody className="divide-y divide-gray-200">
                      {increament.person.map((p, i) => (
                        <tr key={i}>
                          ...
                          <td className="px-4 py-3 text-sm text-center border border-gray-300 font-medium">
                            {p.name}
                          </td>
                          <td className="px-4 py-3 text-sm text-center border border-gray-300">
                            {p.section}
                          ...
                          <td className="px-4 py-3 text-sm text-center border border-gray-300 font-bold">
                    ...
                    <tfoot>
                      <tr className="bg-gray-100">
                        <td colSpan={5} className="px-4 py-3 text-sm text-right font-bold border border-gray-300">
                          মোট:
                        </td>
                        <td className="px-4 py-3 text-sm text-center font-bold border border-gray-300">
              ...
              <div className="mt-8">
                ...
                <div className="mt-6 text-right">
                  <p className="font-[family-name:var(--font-tiro-bangla)] text-base">
              ...
              <div className="mt-20 signature-section">
                <div className="flex justify-center">
                  <div className="text-center">
                    ...
                    <p className="font-[family-name:var(--font-tiro-bangla)] text-sm mt-2">
                      (মোহাম্মদ হাবিবুর রহমান)
                    </p>
                    <p className="font-[family-name:var(--font-tiro-bangla)] text-xs">
                      ব্যাবস্থাপক কারখানা
                    </p>
                    <p className="font-[family-name:var(--font-tiro-bangla)] text-xs">
                      এস এন্ড বি নাইস ফুড ভ্যালি লিঃ
          ...
          {editMode && hasChanges && (
            <div className="sticky bottom-6 mt-8 p-4 bg-gradient-to-r from-blue-50 to-white border-2 border-blue-300 rounded-xl shadow-lg no-print">
              <div className="flex flex-col sm:flex-row items-center justify-between gap-4">
                ...
                <div className="flex gap-3">
                  ...
                  <button
                    onClick={saveChanges}
                    disabled={saving}
                    className="px-5 py-2.5 bg-gradient-to-r from-blue-600 to-blue-700 text-white rounded-lg font-medium hover:from-blue-700 hover:to-blue-800 transition-all duration-200 disabled:opacity-50 disabled:cursor-not-allowed"
                  >
      ...
      <div className="fixed bottom-4 right-4 z-50 md:hidden no-print">
        <button
          onClick={handlePrint}
          className="flex items-center justify-center w-14 h-14 bg-gradient-to-r from-blue-600 to-blue-700 hover:from-blue-700 hover:to-blue-800 text-white rounded-full shadow-lg shadow-blue-500/50"
        >
